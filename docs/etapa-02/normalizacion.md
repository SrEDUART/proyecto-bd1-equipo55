...
* **Atributo:** `detalle_venta.precio_unitario_catalogo`
...
* **Análisis de Normalización:** La 3FN exige eliminar dependencias transitivas y atributos calculados que puedan obtenerse a partir de otros datos (por ejemplo, `subtotal = cantidad * precio_unitario_catalogo`).
