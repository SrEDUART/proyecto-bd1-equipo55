...
| **RN.05** | **Métodos de Pago y descuentos** | Una venta puede saldarse con uno o varios métodos de pago (efectivo, tarjetas, transferencias, etc.). El total de la venta varía según el método de pago seleccionado, aplicándose o no un descuento si corresponde. |
